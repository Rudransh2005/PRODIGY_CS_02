...
def en_fun(x):
    ...
    if image_input is not None:
        ...
        filename = filedialog.asksaveasfile(mode='w',defaultextension=".jpg", filetypes=[("JPED files", "*.jpg")])
        if filename:
...
download_encrypted = Button(window, text="Download Encrypted", command=download_encrypted, font=("Arial", 15), bg="light blue", fg="blue", borderwidth=3, relief="raised")
download_encrypted.place(x=30, y=670)

download_decrypted = Button(window, text="Download Decrypted", command=download_decrypted, font=("Arial", 15), bg="light blue", fg="blue", borderwidth=3, relief="raised")
download_decrypted.place(x=220, y=670)
